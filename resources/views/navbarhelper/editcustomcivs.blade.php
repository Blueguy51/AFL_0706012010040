...
<form action="{{ route ('listofcivilization.update', $civdata['civcode']) }}" METHOD="POST" enctype="multipart/form-data">
  @csrf
  ...
  <table class="table table-dark table-striped table-bordered border-light ">
    <tr>
      <td class="text text-center" colspan="3">
        <h1>Edit Custom Civilization</h1>
      </td>
    </tr>
    <tr>
  ...
  <button type="text" class="btn btn-dark btn-lg">Update</button>
